...
import (
	...
	"github.com/lionelvillard/knative-functions-controller/pkg/dynamic/dynamicinformer"
)
...
func withInformerFactory(ctx context.Context) context.Context {
	...
	return context.WithValue(ctx, Key{},
		dynamicinformer.NewDynamicSharedInformerFactory(kc, controller.GetResyncPeriod(ctx)))
}
